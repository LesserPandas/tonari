...
<body>
	...
	<div class="bg-category">
		<div class="container">
			<div class="ct-group btn-group" role="group">
				<button type="button" class="btn-category">일본어</button>
				<button type="button" class="btn-category">중국어</button>
				<button type="button" class="btn-category">JAVA</button>
				<button type="button" class="btn-category">PYTHON</button>
			</div>
			<div class="ct-group btn-group" role="group">
				<button type="button" class="btn-category">JAVASCRIPT</button>
				<button type="button" class="btn-category">SPRING</button>
				<button type="button" class="btn-category">HTML5+CSS3</button>
				<button type="button" class="btn-category">DATABASE</button>
		...
		<div class="container">
			<div class="row">
				<div id="carousel-reviews" class="carousel slide"
						...
						<div class="item active">
							<div class="col-md-4 col-sm-6">
								<div class="block-text rel zmin">
									...
									<div class="mark">
										My rating: <span class="rating-input"><span
									...
									<p>Never before has there been a good film portrayal of
										ancient Greece's favourite myth. So why would Hollywood start
										now? This latest attempt at bringing the son of Zeus to the
										big screen is brought to us by X-Men: The last Stand director
							...
							<div class="col-md-4 col-sm-6 hidden-xs">
								<div class="block-text rel zmin">
									...
									<p>The 2013 movie "The Purge" left a bad taste in all of
										our mouths as nothing more than a pseudo-slasher with a
										hamfisted plot, poor pacing, and a desperate attempt at
										"horror." Upon seeing the first trailer for "The Purge:
										Anarchy," my first and most immediate thought was "we really
										don't need another one of these."</p>
									<ins class="ab zmin sprite sprite-i-triangle block"></ins>
								</div>
								<div class="person-text rel">
									<img
							...
							<div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
								<div class="block-text rel zmin">
									...
									<p>What a funny and entertaining film! I did not know what
										to expect, this is the fourth film in this vehicle's universe
										...
										fantastic sequel in this magical franchise.</p>
									<ins class="ab zmin sprite sprite-i-triangle block"></ins>
								</div>
								<div class="person-text rel">
									<img
					...
					<a class="left carousel-control" href="#carousel-reviews"
						role="button" data-slide="prev"> <span
						class="glyphicon glyphicon-chevron-left"></span>
					</a> <a class="right carousel-control" href="#carousel-reviews"
